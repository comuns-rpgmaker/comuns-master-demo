...
//----------------------------------------------------------------------------
// 07/07/21 | Version: 1.0.1 | Changed the hud to be above the battlefield layer.
// 09/11/20 | Version: 1.0.0 | Released
//----------------------------------------------------------------------------
...
/*:
 * @target MZ
 * @plugindesc [v1.0.1] Akea Animated Battler Order
...
(() => {
    ...
    Spriteset_Battle.prototype.createUpperLayer = function () {
        _Spriteset_Battle_createUpperLayer.call(this, ...arguments);
    ...
    Spriteset_Battle.prototype.createBaseBattleOrderHud = function () {
        this._battleOrderHud = new Sprite();
        ...
        this._battleOrderHud.addChild(sprite);
        this.addChild(this._battleOrderHud);
    };
