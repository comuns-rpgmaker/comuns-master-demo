...
// Akea Battle Camera
//----------------------------------------------------------------------------
// 04/08/21 | Version: 1.1.1 | Added Smooth Mode parameter
...
/*:
 * @target MZ
 * @plugindesc [v1.1.1] Akea Battle Camera
 ...
 * @default false
 * 
 * @param bitmapSmoothMode
 * @text Bitmap Smooth Mode
 * @desc Set false if you want to use the Nearest Neighbor on the bitmap scale mode. Is Linear when true.
 * @type boolean
 * @default false
 */
...
Akea.BattleCamera.VERSION = [1, 1, 1];
...
(() => {
    ...
    Akea.BattleCamera.resetCameraActionEnd = Akea.params.resetCameraActionEnd == "true";
    Akea.BattleCamera.bitmapSmoothMode = Akea.params.bitmapSmoothMode == "true";
    ...
    Bitmap.prototype.initialize = function() {
        _Bitmap_initialize.call(this, ...arguments);
        this._smooth = Akea.BattleCamera.bitmapSmoothMode;
    };
